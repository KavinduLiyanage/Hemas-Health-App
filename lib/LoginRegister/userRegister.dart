                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(0.0, 288.0, 169.0, 42.0),
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(17.0, 22.0, 57.0, 20.0),
                                      size: Size(169.0, 42.0),
                                      pinLeft: true,
                                      pinBottom: true,
                                      fixedWidth: true,
                                      fixedHeight: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(94.0, 22.0, 75.0, 20.0),
                                      size: Size(169.0, 42.0),
                                      pinRight: true,
                                      pinBottom: true,
                                      fixedWidth: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 0.0, 80.0, 17.0),
                                      size: Size(169.0, 42.0),
                                      pinLeft: true,
                                      pinTop: true,
                                      fixedWidth: true,
